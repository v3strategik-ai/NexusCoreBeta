...
import { TimeBasedTriggers } from './components/TimeBasedTriggers'
import { MultiStepApprovalProcesses } from './components/MultiStepApprovalProcesses'
import { WebhookApiAutomation } from './components/WebhookApiAutomation'
import { NaturalLanguageWorkflows } from './components/NaturalLanguageWorkflows'
    ...
    <ThemeProvider>
      ...
      <div className="container mx-auto px-4 py-6">
        <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
            ...
            {operationsTab === 'workflows' && (
              <div>
                <div className="flex justify-between items-center mb-6">
                  <div>
                    <h3 className="text-2xl font-bold text-foreground">Advanced Workflows & Automation</h3>
                    <p className="text-muted-foreground mt-1">Build, manage, and execute complex business workflows</p>
                  </div>
                  <div className="flex gap-2">
          ...
          {/* Enterprise Tab - Now includes both Management and Architecture */}
          <TabsContent value="enterprise" className="space-y-6">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold gradient-text mb-2">Enterprise Management</h2>
              <p className="text-muted-foreground">Tenant management, user administration, and advanced enterprise architecture</p>
            </div>
            ...
            <div className="border-b border-gray-200 mb-6">
              <nav className="flex space-x-8">
                ...
                <button
                  onClick={() => setEnterpriseTab('architecture')}
                  className={`py-2 px-1 border-b-2 font-medium text-sm ${
